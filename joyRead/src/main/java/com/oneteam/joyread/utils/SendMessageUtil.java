package com.oneteam.joyread.utils;
...
public class SendMessageUtil {
    ...
    /**
     * @param Uid SMS用户id:siqianwu
     * @param Key 接口密钥
     * @param sendPhoneNum 短信发送目标号码
     * @param desc 短信内容
     * @return Integer(1:成功码，其它失败，具体见注释)
     */
    ...
    public static String sendMessage(String phone) {
        ...
        Integer resultCode =
                SendMessageUtil.send("siqianwu","d41d8cd98f00b204e980", phone, "验证码："+randomCode+"【愉阅】5分钟内有效，欢迎您使用愉阅！");
